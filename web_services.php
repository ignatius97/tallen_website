                ...
                <div class="row align-items-center justify-content-start">
                    <div class="col-lg-12 col-md-12">
                        <div class="slider_text">
                            <h3><a class=" wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s" href="products.php">Visit Our Works</a></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="blog_left_sidebar">
                    ...
                    <article class="blog_item">
                            <div class="blog_details">
                                ...
                                <img src="img/webhost.webp" style="width:100%; height:300px" class="img-fluid">
