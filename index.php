...
story of limitless possibilities that starts with the people, built by the people for the people.
                            ...
                            <a href="about.php" class="boxed-btn3 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div data-scroll-index="0" class="get_in_tauch_area" id="contact" style="background-color: white;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center ">
