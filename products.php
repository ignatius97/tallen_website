...
<body>
    ...
    <div class="container">
               ...
               <div class="slider_text">
                ...
                <div class="row justify-content-center">
                       <div class="col-md-3 offset-md-3">
                           <a class="boxed-btn3 wow fadeInLeft"  data-wow-duration="1s" data-wow-delay=".2s" href="#kanika">Kanika</a>
                       </div>
                       <div class="col-md-3">
                          <a class="boxed-btn3 wow fadeInRight"  data-wow-duration="1s" data-wow-delay=".2s" href="#gonza">Gonza</a>
                       </div>
                       <div class="col-md-3">
                          <a class="boxed-btn3 wow fadeInRight"  data-wow-duration="1s" data-wow-delay=".2s" href="#">Sooma</a>
                      </div>
                </div>                          
            </div>
          </div>
     ...
     <section class="section-padding" id="kanika" style="background-color: ghostwhite;">
                ...
                <div class="col-lg-5 offset-lg-2">
                    <div class="about_info">
                        <div class="section_title white_text">
                            ...
                            <a href="#" class="boxed-btn3 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">Get kanika</a>
                        </div>
                    </div>
                </div>
            </div>
     ...
     <section class="section-padding" id="gonza" style="background-color: ghostwhite;">
        ...
        Sounds easy right! Yes, it is because GONZA makes it so and this is how. With creation of just one account on our mobile application, you are ushered into a world of limitless possibilities. Get expert career advice from real mentors to make that informed decision, receive hands on customized coaching in searching for the right job, learn to write an application letter and CV and test your confidence through mock interviews. The platform also provides genuine information on current internship and job opportunities for entry talent. Seems like a lot, but the beauty is, all this at just a click of a button.
                            ...
                            <a href="#" class="boxed-btn3 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">Get Gonza</a><br><br><br>
                        </div>
                    </div>
                </div>
            </div>
